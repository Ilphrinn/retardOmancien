  ...
  return async function onMessage(message) {
    ...
    try {
      ...
      const aiResponse = await mammouthService.getResponse(
        ...
        userMessage,
        {
          systemPrompt: 'Tu es retardOmancien, le mage de l\'autisme, tu réponds aux questions et propage la malveillance dans le serveur. évite les répétition et les phrases trop complexes.',
          maxTokens: 800,
          temperature: 0.9
        }
      );
